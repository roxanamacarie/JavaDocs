...
hrApp.service('EmployeeService', ['$http', 'CommonResourcesFactory', function($http, CommonResourcesFactory) {
        return {
            ...
            findOne: function(employeeId) {
                return $http.get(CommonResourcesFactory.findOneEmployeeUrl, {params: {id: employeeId}})
                    .success(function(data) {
                        return data;
                    })
                    .error(function(data) {
            ...
            delete: function(employeeId) {
                return $http.delete(CommonResourcesFactory.deleteEmployeeUrl,{params: {id: employeeId}})
                    .success(function(data) {
                        return data;
                    })
                    .error(function(data) {
